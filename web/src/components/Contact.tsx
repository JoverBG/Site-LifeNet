      ...
      <div className="space-y-4">
        <a href={whatsappLink} target="_blank" rel="noopener"
          ...
          <div className="flex items-center gap-4">
            <i className="fa-brands fa-whatsapp text-4xl text-[#25D366] group-hover:scale-110 transition" />
        ...
        <a href={instagram} target="_blank" rel="noopener"
          ...
          <div className="flex items-center gap-4">
            <i className="fa-brands fa-instagram text-4xl text-pink-500 group-hover:scale-110 transition" />
